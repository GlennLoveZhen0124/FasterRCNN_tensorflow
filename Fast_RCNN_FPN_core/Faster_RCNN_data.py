...
if __name__ == '__main__':
	...
	'''
	proposals_y1 = proposals[:, 0]
	print('img: ', img, img.dtype, img.shape)
	...
	y1_tensor = tf.Variable(proposals_y1)
	print(y1_tensor)
	y1_ = tf.reshape(y1_tensor, [-1])
	print(y1_)
	yy = tf.expand_dims(y1_tensor, axis=1)
	print(yy)
	yyy = tf.reshape(yy, [-1])
	print(yyy)

	print('all_GT_x: ', all_GT_x.shape)
	print('all_GT_boxes: ', all_GT_boxes.shape)
	'''
